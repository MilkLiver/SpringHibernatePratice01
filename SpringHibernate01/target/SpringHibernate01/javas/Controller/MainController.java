...
public class MainController {
    ...
    public String fileUpload_GET(ModelMap model, HttpServletRequest request, HttpServletResponse response) {
    ...
    public String fileDownload(ModelMap model, HttpServletRequest request, HttpServletResponse response) {
        return "fileDownload";
    }
